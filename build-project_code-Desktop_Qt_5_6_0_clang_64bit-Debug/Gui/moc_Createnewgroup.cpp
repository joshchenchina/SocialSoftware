...
#include "../../project/Gui/Createnewgroup.h"
...
const QMetaObject CreateNewGroup::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_CreateNewGroup.data,
      qt_meta_data_CreateNewGroup,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CreateNewGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CreateNewGroup.stringdata0))
