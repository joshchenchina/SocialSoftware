...
public:
    ...
    void retranslateUi(QMainWindow *AdminMainMenu)
    {
        ...
        addUsersButton->setText(QApplication::translate("AdminMainMenu", "Add Users to Blogs/ Delete Groups", 0));
